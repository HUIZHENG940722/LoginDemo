...
public class RegisterForm {
    ...
    public String getSecondUserPwd() {
        return secondUserPwd;
    }

    public void setSecondUserPwd(String secondUserPwd) {
        this.secondUserPwd = secondUserPwd;
    }
    ...
    public boolean validate(){
        ...
        // 两次密码要一致
        if (this.secondUserPwd != null) {
            if (!this.secondUserPwd.equals(this.userPwd)) {
                isOk = false;
